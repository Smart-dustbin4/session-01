...
for i in matrix1:
    for j in i:
        print(j,end=" ")
    print()
#inserting values at 3rd row 
matrix1.insert(2,[9,9,9])
print("After inserting values at 3rd row: ")
for i in matrix1:
    for j in i:
        print(j,end=" ")
    print()
#inserting an element
matrix1[3].insert(4,10)
print("Modified matrix after inserting 10 at row4 col4: ")
for i in matrix1:
    for j in i:
        print(j,end=" ")
    print()
...
for i in matrix1:
    ...
    print()
   #lenghth of row3
row3_length=len(matrix1[2])
print("Length of row3: ", row3_length)
...
# Write your code below:
Mixed_tuple = ("Tabassum Siraj", 23, True, 50.05)
...
# Write your code below:
students = [("Samu", 52), ("Jamu", 72), ("Tabu", 62), ("Ranu", 82), ("Faru", 92)]
