...
student = {'name': 'Tabassum','roll_number': 'C193210','grades': {'Math': 95, 'Science': 90, 'Bangla': 82}}
print("Student information:" ,student.items())

# Adding a new subject and grade
student['grades']['Religion'] =96
student['grades']['Physics'] = 55

# Modifying the grade for a subject
student['grades']['Math'] = 60
student['grades']['Bangla'] = 40
...
for student, grades in student_grades.items():
    ...
    print("Avarage grades for each student:")
